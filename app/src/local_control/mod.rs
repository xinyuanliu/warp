...
//! localhost credential broker directly. Authenticated-user grants require an
//! app-issued, registry-verified Warp terminal proof and the selected app user
//! to be logged in. The client then presents that bearer token to `/v1/control`,
