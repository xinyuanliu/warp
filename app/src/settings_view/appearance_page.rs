...
impl AppearanceSettingsPageView {
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        ...
        if !window_settings_widgets.is_empty() {
            categories.push(Category::new(warp_core::t!("Window"), window_settings_widgets));
        }
        ...
        if !tools_panel_widgets.is_empty() {
            categories.push(Category::new(warp_core::t!("Tools panel"), tools_panel_widgets));
        }
        ...
        categories.push(Category::new(warp_core::t!("Input"), category_widgets));
        ...
        categories.push(Category::new(warp_core::t!("Blocks"), block_settings_widgets));
        ...
        categories.push(Category::new(warp_core::t!("Text"), text_settings_widgets));
        ...
        categories.push(Category::new(warp_core::t!("Tabs"), tab_settings_widgets));

        categories.push(Category::new(
            warp_core::t!("Full-screen Apps"),
    ...
    fn set_language(&mut self, new_lang: warp_core::Language, ctx: &mut ViewContext<Self>) {
        ...
        if current != new_lang {
            ...
            // NOTE: do not update `self.language_dropdown` from here. The
            // dropdown already reflects the user's click (the action was
            // dispatched from the dropdown itself), and updating it from
            // within the action handler creates a circular view reference
            // that panics — see the analogous `set_input_mode` guard on
            // `from_binding`.
            ctx.notify();
        }
    }
    ...
    fn render(
        ...
        Flex::column()
            ...
            .with_child(render_body_item::<AppearancePageAction>(
                warp_core::t!("Sync with OS", "跟随系统").into(),
                None,
...
impl SettingsWidget for CustomWindowSizeWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            warp_core::t!("Open new windows with custom size", "以自定义尺寸打开新窗口").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for WindowBlurTextureWidget {
    ...
    fn render(
        ...
        let mut col = Flex::column().with_child(render_body_item::<AppearancePageAction>(
            warp_core::t!("Use Window Blur (Acrylic texture)", "使用窗口模糊（亚克力纹理）").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ToolsPanelStateScopeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Tools panel visibility is consistent across tabs", "工具面板在各标签页中保持一致的显示状态").to_string(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for InputTypeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Input type", "输入类型").into(),
            None,
            LocalOnlyIconState::Hidden,
            ToggleState::Enabled,
            appearance,
...
impl SettingsWidget for DimInactivePanesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Dim inactive panes", "淡化非活跃面板").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for FocusFollowsMouseWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Focus follows mouse", "焦点跟随鼠标").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CompactModeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Compact mode", "紧凑模式").into(),
            None,
            LocalOnlyIconState::for_setting(
                Spacing::storage_key(),
...
impl SettingsWidget for JumpToBottomOfBlockWidget {
    ...
    fn render(
        ...
        let enabled = block_list_settings
            ...
            .value();
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Show Jump to Bottom of Block button", "显示'跳到块底部'按钮").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowBlockDividersWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Show block dividers", "显示块分隔线").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AIFontWidget {
    ...
    fn render(
        ...
        ai_font.add_child(render_body_item_label::<AppearancePageAction>(
            warp_core::t!("Agent font", "代理字体").to_string(),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for TerminalFontWidget {
    ...
    fn render(
        ...
        terminal_font.add_child(render_body_item_label::<AppearancePageAction>(
            warp_core::t!("Terminal font", "终端字体").to_string(),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for LigaturesWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Show ligatures in terminal", "在终端中显示连字").into(),
            Some(AdditionalInfo {
...
impl SettingsWidget for CursorTypeWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Cursor type", "光标类型").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for BlinkingCursorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Blinking cursor", "光标闪烁").into(),
            None,
            LocalOnlyIconState::for_setting(
                CursorBlinkEnabled::storage_key(),
                CursorBlinkEnabled::sync_to_cloud(),
...
impl SettingsWidget for TabIndicatorWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Show tab indicators", "显示标签指示符").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CodeReviewButtonWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Show code review button", "显示代码审查按钮").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for VerticalTabsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Use vertical tab layout", "使用垂直标签布局").into(),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowVerticalTabPanelInRestoredWindowsWidget {
    ...
    fn render(
        ...
        render_body_item::<AppearancePageAction>(
            warp_core::t!("Show vertical tabs panel in restored windows", "在还原的窗口中显示垂直标签面板").into(),
            None,
            LocalOnlyIconState::for_setting(
