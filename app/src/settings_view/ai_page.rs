...
impl SettingsWidget for CloudAgentComputerUseWidget {
    ...
    fn render(
        ...
        Flex::column()
            ...
            .with_child(render_ai_setting_description(
                "Use Warp-hosted storage for artifacts generated by Computer Use, including screenshots attached to PRs. Self-hosted artifact store configuration will be added later.",
                is_computer_use_effectively_enabled,
                app,
            ))
            .finish()
