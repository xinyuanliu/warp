        ...
        *lock = true;
        toggle_binding_pairs.push(
            ToggleSettingActionPair::new(
                warp_core::t!("settings sync", "设置同步"),
...
impl MainSettingsPageView {
    pub fn new(ctx: &mut ViewContext<MainSettingsPageView>) -> Self {
        ...
        let page = PageType::new_uncategorized(widgets, Some(warp_core::t!("Account", "账户")));
...
impl AccountWidget {
    fn render_anonymous_account_info(
        ...
        let user_info = appearance
            ...
            .with_text_label(warp_core::t!("Sign up", "注册").to_owned())
            .build()
        ...
        plan_info.add_child(render_customer_type_badge(appearance, warp_core::t!("Free", "免费版").into()));
        plan_info.add_child(
            Container::new(
                appearance
                    .ui_builder()
                    ...
                    .with_text_and_icon_label(
                        TextAndIcon::new(
                            ...
                            warp_core::t!("Compare plans", "对比套餐"),
    ...
    fn render_account_info(
        ...
        if let Some(team) = workspaces.current_team() {
                ...
                if team.billing_metadata.customer_type == CustomerType::Enterprise {
                    plan_info.add_child(
                        appearance
                            .ui_builder()
                            .link(
                                warp_core::t!("Contact support", "联系支持").into(),
                    ...
                    if team.has_billing_history {
                        ...
                        plan_info.add_child(
                            appearance
                                .ui_builder()
                                .link(
                                    warp_core::t!("Manage billing", "管理订阅").into(),
                                    None,
                    ...
                    if team.billing_metadata.can_upgrade_to_higher_tier_plan() {
                        let description = match team.billing_metadata.customer_type {
                            CustomerType::Prosumer => warp_core::t!("Upgrade to Turbo plan", "升级到 Turbo 套餐"),
                            CustomerType::Turbo => warp_core::t!("Upgrade to Lightspeed plan", "升级到 Lightspeed 套餐"),
                            _ => "Compare plans",
                        };
                        let team_uid = team.uid;
                        plan_info.add_child(
            ...
            let plan_badge_child = render_customer_type_badge(appearance, warp_core::t!("Free", "免费版").into());
            ...
            plan_info.add_child(
                appearance
                    .ui_builder()
                    .link(
                        warp_core::t!("Compare plans", "对比套餐").into(),
                        None,
                        Some(Box::new(move |ctx| {
                            ctx.dispatch_typed_action(MainPageAction::Upgrade {
                                team_uid: None,
...
impl SettingsWidget for SettingsSyncWidget {
    ...
    fn render(
        ...
        Container::new(render_body_item::<MainPageAction>(
            warp_core::t!("Settings sync", "设置同步").to_string(),
            Some(label_info),
        ...
        Container::new(
            self.render_row(
                ...
                appearance
                    .ui_builder()
                    .link(
                        warp_core::t!("Refer a friend", "推荐好友").into(),
                        None,
                        Some(Box::new(move |ctx| {
            ...
            if ContextFlag::PromptForVersionUpdates.is_enabled() {
                ...
                match autoupdate::get_update_state(app) {
                    AutoupdateStage::NoUpdateAvailable => (
                        Some(StatusContent {
                            text: warp_core::t!("Up to date", "已是最新版本"),
                            color: faded_text_color,
                        }),
                        Some(CallToActionContent {
                            text: warp_core::t!("Check for updates", "检查更新"),
                            action: MainPageAction::CheckForUpdate,
                        }),
                    ),
                    AutoupdateStage::CheckingForUpdate => (
                        Some(StatusContent {
                            text: warp_core::t!("checking for update...", "正在检查更新..."),
                            color: faded_text_color,
                        }),
                        None,
                    ),
                    AutoupdateStage::DownloadingUpdate => (
                        Some(StatusContent {
                            text: warp_core::t!("downloading update...", "正在下载更新..."),
                            color: faded_text_color,
                        }),
                        None,
                    ),
                    AutoupdateStage::UpdateReady { .. } => (
                        Some(StatusContent {
                            text: warp_core::t!("Update available", "有可用更新"),
                            color: ansi_red,
                        }),
                        Some(CallToActionContent {
                            text: warp_core::t!("Relaunch Warp", "重启 Warp"),
                            action: MainPageAction::Relaunch,
                        }),
                    ),
                    AutoupdateStage::Updating { .. } => (
                        Some(StatusContent {
                            text: warp_core::t!("Updating...", "正在更新..."),
                            color: faded_text_color,
                        }),
                        None,
                    ),
                    AutoupdateStage::UpdatedPendingRestart { .. } => (
                        Some(StatusContent {
                            text: warp_core::t!("Installed update", "已安装更新"),
                            color: faded_text_color,
                        }),
                        Some(CallToActionContent {
                            text: warp_core::t!("Relaunch Warp", "重启 Warp"),
                    ...
                    AutoupdateStage::UnableToUpdateToNewVersion { .. } => (
                        Some(StatusContent {
                            text: warp_core::t!("A new version of Warp is available but can't be installed", "有新版本 Warp 可用，但无法安装"),
                            color: ansi_red,
                        }),
                        Some(CallToActionContent {
                            text: warp_core::t!("Update Warp manually", "手动更新 Warp"),
                    ...
                    AutoupdateStage::UnableToLaunchNewVersion { .. } => (
                        Some(StatusContent {
                            text: warp_core::t!("A new version of Warp is installed but can't be launched.", "新版本 Warp 已安装，但无法启动。"),
                            color: ansi_red,
                        }),
                        Some(CallToActionContent {
                            text: warp_core::t!("Update Warp manually", "手动更新 Warp"),
        ...
        let mut first_row = Flex::row()
            ...
            .with_child(
                Shrinkable::new(
                    ...
                    Align::new(
                        Text::new_inline(
                            warp_core::t!("Version", "版本").to_string(),
                            appearance.ui_font_family(),
                            REGULAR_TEXT_FONT_SIZE,
                        )
